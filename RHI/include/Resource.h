...
enum PipelineStageFlags : uint32_t {
    ...
    PIPELINE_STAGE_INDEX_INPUT = 1 << 1,
    PIPELINE_STAGE_VERTEX_INPUT = 1 << 2,
    PIPELINE_STAGE_VERTEX_SHADER = 1 << 3,
    PIPELINE_STAGE_FRAGMENT_SHADER = 1 << 4,
    PIPELINE_STAGE_EARLY_FRAGMENT_TESTS = 1 << 5,
    PIPELINE_STAGE_LATE_FRAGMENT_TESTS = 1 << 6,
    PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT = 1 << 7,
    PIPELINE_STAGE_COMPUTE_SHADER = 1 << 8,
